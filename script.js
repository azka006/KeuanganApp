  ...
  class VoiceAssistant {
      constructor() {
          ...
          this.commands = {
              ...
              'tema macha': () => this.switchThemeCommand('macha'),
              'tema lemon': () => this.switchThemeCommand('lemon'),
              'tema coffee': () => this.switchThemeCommand('coffee'),
              'tema twilight': () => this.switchThemeCommand('twilight'),
              'tema orange': () => this.switchThemeCommand('orange'),
              'tema workspace': () => this.switchThemeCommand('workspace'),
              'tema princess': () => this.switchThemeCommand('princess'),
              'tema sea': () => this.switchThemeCommand('sea'),
